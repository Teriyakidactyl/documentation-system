...
```text
python3 "a. Document Design/a. Assemblies/a. Elements/b. Semantic Registry/semantic_registry.py" check PATH SELECTOR
```

Preview the canonical YAML block:

```text
python3 "a. Document Design/a. Assemblies/a. Elements/b. Semantic Registry/semantic_registry.py" format PATH SELECTOR
```

Apply the deterministic formatting:

```text
python3 "a. Document Design/a. Assemblies/a. Elements/b. Semantic Registry/semantic_registry.py" format --write PATH SELECTOR
```
