...
description: >-
  ...
  review, convergence, or process compilation* `to` **select retained
  planning reference material that can strengthen plan construction without
  treating that material as current Work Management authority**.
---
# Planning Reference

This location retains planning-support source material used to broaden,
interrogate, or compile plans when ordinary decomposition is insufficient.

The material is reference input, not current Work Management authority. Apply
