...
from documentation_system.operations.markdown import MARKDOWN_FIX,MARKDOWN_GET_SECTION,MARKDOWN_HEADINGS,MARKDOWN_LINT,MARKDOWN_RENUMBER,MARKDOWN_RULES,MARKDOWN_SECTIONS
from .common import require_success

def main(argv: list[str] | None=None) -> None:
    parser=argparse.ArgumentParser(prog="documentation_system markdown")
