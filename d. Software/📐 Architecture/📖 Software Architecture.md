...
uid: K7W3P9
form:
  path: '<a href="../../f.%20Technical%20Writing/a.%20Document/b.%20Document%20Forms/b.%20Architecture%20Document/README.md" uid="T6P28F">documentation-system:§f.a.b.b</a>'
  version: '1.0'
description: >-
...
rooted at `d. Software`: the public executable and procedural entry surfaces, the
...
`d. Software`. Python tools use source-local module docstrings as their indexed
...
`d. Software/tests/test_capabilities.py` exercises representation-capability
