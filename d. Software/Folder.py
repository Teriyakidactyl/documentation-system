...
```text
python3 "d. Software/Folder.py" SOURCE DESTINATION
python3 "d. Software/Folder.py" --apply SOURCE DESTINATION
```
...
```text
python3 "d. Software/Folder.py" strip-prefix ROOT --match REGEX
python3 "d. Software/Folder.py" strip-prefix ROOT --match REGEX --apply
```
...
```text
python3 "d. Software/Folder.py" strip-prefix "d. Software" \
  --files-only \
  --include "*.py" \
  --match '^[0-9]+ '
```
