...
OWNER=Source("repo_manager.capabilities.folder","d. Software/repo_manager/capabilities/folder.py")
CAPABILITY=Source("repo_manager.capabilities.folder","d. Software/repo_manager/capabilities/folder.py")
