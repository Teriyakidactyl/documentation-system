...
description: "`Consult when` *documented information must be authored, controlled, or Documentation System tooling must be run* `to` **select and apply the narrowest Documentation System procedure from README.md**."
---
