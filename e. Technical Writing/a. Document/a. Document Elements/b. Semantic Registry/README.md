...
<a href="../3.%20%F0%9F%93%96%20Glossary.md" uid="BJS5BZ">documentation-system:§e.a.a.3</a>
...
```text
python3 "e. Technical Writing/a. Document/a. Document Elements/b. Semantic Registry/semantic_registry.py" check PATH SELECTOR
```

Preview the canonical YAML block:

```text
python3 "e. Technical Writing/a. Document/a. Document Elements/b. Semantic Registry/semantic_registry.py" format PATH SELECTOR
```

Apply the deterministic formatting:

```text
python3 "e. Technical Writing/a. Document/a. Document Elements/b. Semantic Registry/semantic_registry.py" format --write PATH SELECTOR
```
