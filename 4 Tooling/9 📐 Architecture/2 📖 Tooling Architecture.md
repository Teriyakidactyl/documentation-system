...
rooted at `4 Tooling`: the public executable and procedural entry surfaces, the
...
<a href="1%20%F0%9F%93%96%20Organizing%20Architecture.md" uid="55NHDB">documentation-system:§4.9.1</a>
...
`4 Tooling`. Python tools use source-local module docstrings as their indexed
...
- `4 Tooling/tests` for executable coverage of the shared capability and
...
`4 Tooling/tests/test_capabilities.py` exercises representation-capability
...
`4 Tooling/tests/test_organizing.py` exercises corpus semantics and the
