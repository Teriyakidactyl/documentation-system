...
```text
python3 "4 Tooling/Markdown.py" headings PATH
python3 "4 Tooling/Markdown.py" sections PATH
python3 "4 Tooling/Markdown.py" get-section PATH SELECTOR
python3 "4 Tooling/Markdown.py" lint PATH
python3 "4 Tooling/Markdown.py" fix PATH
python3 "4 Tooling/Markdown.py" rules
python3 "4 Tooling/Markdown.py" renumber [--write] PATH
```
